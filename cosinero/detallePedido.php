                ...
                <tbody>
                    ...
                    foreach ($productos as $producto) {
                        ...
                        <tr>
                            ...
                            <?php if ($producto->Estado == 'Cancelado' || $producto->Estado == 'Completado' ): ?>
                            ...
                            <?php else: ?>
                                ...
                                <td>
                                    <form action="../mesero/eliminar_pedido.php" method="post">
                                        <input type="hidden" name="id_pedido" value="<?php echo $producto->Numero_Pedido ?>">
                                        <input type="hidden" name="id_producto" value="<?php echo $producto->id_producto ?>">
                                        <button class="button is-danger">
                                            <i class="fa fa-trash-o"></i>
                                ...
                                <td>
                                    <form action="../mesero/Cambia_status_pedido.php" method="post">
                                ...
                                <td>
                                    <form action="../mesero/Cambia_status_pedido.php" method="post">
                                        <input type="hidden" name="status" value="<?php echo $statusPedido = 2 ?>">
                                        <input type="hidden" name="id_pedido" value="<?php echo $producto->Numero_Pedido ?>">
