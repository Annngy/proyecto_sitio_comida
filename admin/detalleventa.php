...
<body>
    ...
    <form action="#" method="POST" class="mb-3">
        <div class="card">
            ...
            <div class="field has-addons">
                <div class="control">
                    <input type="text" name="busqueda" class="input is-small" placeholder="Buscar ventas por id">
                </div>
                <div class="control">
    ...
    $productos = ConsultarTodasLasVentas($busqueda);
    ?>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach ($productos as $producto) {
                        ...
                        ?>
                        <tr>
                            <td><?php echo $producto->Numero_Venta ?></td>
