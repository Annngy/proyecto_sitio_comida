...
<body>
    ...
    <form action="#" method="POST" class="mb-3">
        <div class="card">
            ...
            <div class="field has-addons">
                <div class="control">
                    <input type="text" name="busqueda" class="input is-small ml-5" placeholder="Buscar categoria">
                </div>
                <div class="control">
        ...
        <p class="card-header-title is-size-4">
            ...
            <a href="agregar_categoria.php"class="button is-info ml-5 ">Nueva Categoria</a>
    </form>
    <?php
    ...
    $categorias = ConsultaCategoria($busqueda);
    ?>
